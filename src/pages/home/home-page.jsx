              ...
              >
                ...
                <div className="p-4 space-y-3 bg-white border rounded-lg">
                  ...
                  <p>
                    ...
                    berinteraksi, bertukar informasi, dan belajar dari
                ...
                <div className="p-4 space-y-3 bg-white border rounded-lg">
                  ...
                  <p>
                    WealthWise memiliki koleksi artikel panduan yang membantu
                    Anda untuk memahami berbagai aspek keuangan, dari
                    dasar-dasar investasi hingga strategi perencanaan keuangan
                    yang lebih kompleks.
                  </p>
                </div>
                <div className="p-4 space-y-3 bg-white border rounded-lg">
                  ...
                  <p>
                    WealthWise dapat diakses kapan pun dan dimana pun dengan
                    mudah melalui halaman aplikasi Web WealthWise di berbagai
                    perangkat seperti smartphone, tablet, desktop, hingga
                    laptop.
                  </p>
                </div>
              </Fade>
